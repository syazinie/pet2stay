                    ...
                    <!-- <div class="card-body p-0"> -->
                        ...
                        <div class="row my-3">
                            <div class="col-md-12" style="background:#FAD7A0; border-radius: 20px;">
                                ...
                                <form action="{{route('cust.find_email')}}" method="POST">
                                    @csrf
                                    <div class="row justify-content-center">
                                        <div class="col-4 align-items-center d-flex" style="background:#FEF5E7;">
                                            <label for="email" class="form-label" style="margin-bottom:0px !important;">Please Enter Your Registered Email </label>
                                        </div>
                                        <div class="col-5" style="background:#FEF5E7;">
                                            <input type="text" name="email" class="form-control" placeholder="example@test.com">
                                        </div>
                                    </div>
