...
<div class="container my-4"  style="background-color: #e9edc9; border-radius: 5px; box-shadow: 20px 20px 50px grey; width: 1000px"  >
	<br>

	<h3 class="mb-3">{{$service->title}}</h3>
	<a href="{{url('service/'.$service->id)}}"><img class="card-img-top" src="{{asset('storage/app/'.$service->photo)}}" style="width: 30%; height: 30%;"/> </a>
	<br>
	<br>
