                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" >
                            	<img src="{{asset('public/img/cat2.jpeg')}}" style="width: 100%; height:  100%;">
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4 ">Add Review <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="orange" class="bi bi-hearts" viewBox="0 0 16 16">
                                        ...
                                        <div class="form-group">
                                        	 <textarea name="testi_cont" class="form-control form-control-user" placeholder="Send Us Message" rows="8" ></textarea>                                          
                                        </div>
