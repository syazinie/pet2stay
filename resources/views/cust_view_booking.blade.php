                                    ...
                                    <div class="col-md-12" style="background:#FAD7A0; border-radius: 20px;">
                                        <div class="row p-3">
                                            <div class="col-12 text-center">
                                                ...
                                                @endif
                                                <h1 class="h4 text-gray-900 mb-2">My Booking Information!</h1>
                                            </div>
                                        </div>
                                        <div class="row justify-content-center mb-2">
                                            <div class="col-4" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">Full Name</span>
                                            </div>
                                            <div class="col-5" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">{{$book->customer->full_name}}</span>
                                            </div>
                                        </div>
                                        <div class="row justify-content-center mb-2">
                                            <div class="col-4" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">Room</span>
                                            </div>
                                            <div class="col-5" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">{{$book->room->Roomtype->title}}</span>
                                            </div>
                                        </div>
                                        <div class="row justify-content-center mb-2">
                                            <div class="col-4" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">Check In Date</span>
                                            </div>
                                            <div class="col-5" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">{{$book->checkin_date}}</span>
                                            </div>
                                        </div>
                                        <div class="row justify-content-center mb-2">
                                            <div class="col-4" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">Check Out Date</span>
                                            </div>
                                            <div class="col-5" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">{{$book->checkout_date}}</span>
                                            </div>
                                        </div>
                                        <div class="row justify-content-center mb-5">
                                            <div class="col-4" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">Total Pets</span>
                                            </div>
                                            <div class="col-5" style="background:#FEF5E7;">
                                                <span style="font-size: 16px !important; color:black !important;">{{$book->total_pets}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @else
                            <div class="row my-3">
                                <div class="col-md-12" style="background:#FAD7A0; border-radius: 20px;">
                                    ...
                                    <div class="row justify-content-center mb-5">
                                        <div class="col-8" style="background:#FEF5E7; text-align:center;">
                                            <span style="font-size: 16px !important; color:black !important;">No Booking !</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
